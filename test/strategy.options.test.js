var ReadabilityStrategy = require('../lib/strategy');
...
describe('Strategy#userProfile', function() {
  ...
  describe('with profile URL option', function() {
    var strategy = new ReadabilityStrategy({
        ...
        userProfileURL: 'https://www.readability.com/api/rest/v1/users/_current'
      },
      function() {});
    
      // mock
      strategy._oauth.get = function(url, token, tokenSecret, callback) {
        if (url != 'https://www.readability.com/api/rest/v1/users/_current') { return callback(new Error('incorrect url argument')); }
    ...
    describe('loading profile', function() {
      ...
      it('should parse profile', function() {
        expect(profile.provider).to.equal('readability');
