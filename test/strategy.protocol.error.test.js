      ...
      before(function(done) {
        chai.passport(strategy)
          ...
          .req(function(req) {
            ...
            req.session = {};
            req.session['oauth:readability'] = {};
            req.session['oauth:readability']['oauth_token'] = 'hh5s93j4hdidpola';
            req.session['oauth:readability']['oauth_token_secret'] = 'hdhd0244k9j7ao03';
          })
          .authenticate();
      });
